...
import homework.lessonEighth.taskEighth.groupSerialization.exc.GroupIsEmptyException;
import homework.lessonEighth.taskEighth.groupSerialization.exc.GroupOverflowException;
import homework.lessonEighth.taskEighth.groupSerialization.exc.StudentNotFoundException;
import homework.lessonEighth.taskEighth.groupSerialization.logicalInterfaces.Sorting;
import homework.lessonEighth.taskEighth.groupSerialization.logicalInterfaces.Voencom;
import homework.lessonEighth.taskEighth.groupSerialization.sortType.*;
...
public class Group implements Voencom, Serializable {
    ...
    private final transient Set<Sorting> sort = new HashSet<Sorting>() {{
    ...
    * */
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(groupMembers, group.groupMembers);
    }

    @Override
    public int hashCode() {
        return Arrays.hashCode(groupMembers);
    }
}
